...
PIXELS_PER_LAND_DISTRICT_DEFAULT = 30_000  # 5x territory
PIXELS_PER_LAND_DISTRICT_MIN = PIXELS_PER_LAND_DISTRICT_DEFAULT // 3
PIXELS_PER_LAND_DISTRICT_MAX = PIXELS_PER_LAND_DISTRICT_DEFAULT * 3
PIXELS_PER_LAND_DISTRICT_TICK = (PIXELS_PER_LAND_DISTRICT_MAX - PIXELS_PER_LAND_DISTRICT_MIN) // 100
PIXELS_PER_LAND_DISTRICT_STEP = PIXELS_PER_LAND_DISTRICT_TICK // 2

PIXELS_PER_WATER_DISTRICT_DEFAULT = 175_000  # 5x territory
PIXELS_PER_WATER_DISTRICT_MIN = PIXELS_PER_WATER_DISTRICT_DEFAULT // 3
PIXELS_PER_WATER_DISTRICT_MAX = PIXELS_PER_WATER_DISTRICT_DEFAULT * 3
PIXELS_PER_WATER_DISTRICT_TICK = (PIXELS_PER_WATER_DISTRICT_MAX - PIXELS_PER_WATER_DISTRICT_MIN) // 100
PIXELS_PER_WATER_DISTRICT_STEP = PIXELS_PER_WATER_DISTRICT_TICK // 2
...
DISTRICT_IMAGE_FILENAME = "District Image"
